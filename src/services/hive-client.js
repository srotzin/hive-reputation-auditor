...
const DID='did:hive:hiveforce-reputation';const ID={name:'HiveForce-Reputation',purpose:'Agent reputation auditing — trust scoring, behavior analysis, reliability metrics',capabilities:["trust_scoring","behavior_analysis","reliability_metrics","reputation_history"],did:DID};
...
async function registerWithHiveGate(){return p(`${G}/v1/gate/onboard`,{agent_name:'hive-reputation-auditor',purpose:ID.purpose})}
